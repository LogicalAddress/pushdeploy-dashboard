...
class OAuthBitbucket extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isVerifying: true,
    ...
    componentDidMount() {
        ...
        req.post('/v1/oauth2/bitbucket/create', {code: params.code})
        .then((response) => {
      ...
      return (
        <div>
            <div className="white panel">
                <h3>Connecting your bitbucket account to pushdeploy</h3>
                { this.state.tokenIsGood && <div className="row">
                    <div className="column">
                        <p className="lead">Pushdeploy is now connected to bitbucket, you  can now deploy from private repositories</p>
                    </div>
                </div>}
                { this.state.tokenisBad && <div className="row">
                    <div className="column">
                        <p className="lead">Pushdeploy failed to connect to your bitbucket, please try again. ;-(</p>
                    </div>
                </div>}
            </div>
        </div>
...
export default connect(null, mapDispatchToProps)(OAuthBitbucket)