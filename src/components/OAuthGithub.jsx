...
class OAuthGithub extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            isVerifying: true,
    ...
    componentDidMount() {
        ...
        req.post('/v1/oauth2/github/create', {code: params.code})
        .then((response) => {
      ...
      return (
        <div>
            <div className="white panel">
                <h3>Connecting your github account to pushdeploy</h3>
                { this.state.tokenIsGood && <div className="row">
                    <div className="column">
                        <p className="lead">Pushdeploy is now connected to github, you  can now deploy from private repositories</p>
                    </div>
                </div>}
                { this.state.tokenisBad && <div className="row">
                    <div className="column">
                        <p className="lead">Pushdeploy failed to connect to your github, please try again. ;-(</p>
                    </div>
                </div>}
            </div>
        </div>
...
export default connect(null, mapDispatchToProps)(OAuthGithub)